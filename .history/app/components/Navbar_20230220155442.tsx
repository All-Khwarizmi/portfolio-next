...
function MobileNav({ open, setOpen }: any) {
  ...
  return (
    <nav
      className={`absolute top-0 bg left-0 text-black landing text-white h-screen w-screen transform bg-white ${
        open ? '-translate-x-0' : '-translate-x-full'
      } drop-shadow-md filter min-h-[100%] transition-transform duration-300 ease-in-out `}
    >
