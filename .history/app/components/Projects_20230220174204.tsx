...
const Projects = () => {
  return (
    <section id='projects' className='min-h-full relative projects text-center'>
      <h1
        className={clsx(
          openSans.className,
      ...
      <div className='flex flex-col items-center justify-around lg:flex-row lg:justify-center flex-wrap  px-2'>
        <div className=' w-[80%] h-60 lg:w-[30%] lg:h-96'>
          <Link className='' href={''}>
            <div className=''>
              <img
        ...
        <div className='p-5 w-[80%] h-60 lg:w-[30%] lg:h-96'>
          <Link className='' href={''}>
            <div className=''>
              <img
                className='rounded rounded-bl-none rounded-br-none'
