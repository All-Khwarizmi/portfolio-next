...
function MobileNav({ open, setOpen }: any) {
  ...
  return (
    ...
    >
      <div className='flex h-16  items-center justify-center bg-red-800 drop-shadow-md filter'>
        {' '}
        {/*logo container*/}
      </div>
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='h-16 flex fixed h-screen w-screen drop-shadow-md bg-red-800  justify-end  '>
