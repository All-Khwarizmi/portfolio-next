...
const Projects = () => {
  return (
    <section id='projects' className='min-h-[100%]  projects text-center'>
      ...
      <div className='flex boxshadow-md min-h-[100%] flex-col items-center justify-between lg:flex-row lg:justify-center flex-wrap  px-2'>
        <div className='p-5 w-[80%] lg:w-[30%] lg:h-96'>
          <Link className='' href={''}>
            ...
            <h1
              className={clsx(montserrat.className, 'bg-gray-600 py-2 ')}
            >
              Project
            </h1>
          </Link>
