...
const Projects = () => {
  return (
    <section id='projects' className='min-h-full  projects text-center'>
      <h1
        className={clsx(
          openSans.className,
      ...
      <div className='flex h-[100%] flex flex-row-reverse items-center justify-around lg:flex-row lg:justify-center flex-wrap  px-2'>
