...
const Projects = () => {
  return (
    <section id='projects' className='min-h-[100%]  projects text-center'>
      ...
      <div className='flex min-h-[100%] rounded flex-col items-center justify-between lg:flex-row lg:justify-center flex-wrap  px-2'>
        <div className='p-5 shadow-sm shadow-indigo-500/40  w-[80%] lg:w-[30%] lg:h-96'>
          <Link className='' href={''}>
            <div className=''>
              <img
