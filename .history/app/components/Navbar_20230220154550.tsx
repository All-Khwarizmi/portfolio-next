...
function MobileNav({ open, setOpen }: any) {
  ...
  return (
    <nav
      className={`absolute top-0 overflow-scroll left-0 text-black landing text-white h-screen w-screen transform bg-white ${
        open ? '-translate-x-0' : '-translate-x-full'
      } drop-shadow-md filter  transition-transform duration-300 ease-in-out `}
    >
      <div className='flex h-20 absolute top-0  items-center justify-center bg-red-800 drop-shadow-md filter'>
        {' '}
        {/*logo container*/}
      </div>
