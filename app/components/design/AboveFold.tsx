  ...
  return (
    <div className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 overflow-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        <div className="flex flex-col items-center lg:flex-row lg:items-start justify-between gap-4 lg:gap-8">
            ...
            <p className="text-lg sm:text-xl text-gray-300">
              <Balancer>
                ...
                <span className="sm:hidden">
                  Un site web rapide, intuitif et adaptatif. Des animations fluides 
                  et un back-office simple. C&apos;est ce que je crée pour vous.
                </span>
              </Balancer>
            </p>
